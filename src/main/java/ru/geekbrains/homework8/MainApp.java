...
// Я также перевёл все вспомогательные для конструктора методы в private, хотя на занятии такие методы были сделаны public;
// но ведь эти методы не вызываются и не должны вызываться за пределами класса. Это правильно?
